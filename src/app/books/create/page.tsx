...
export default function CreateBookPage() {
  ...
  return (
    <div>
      <h2 className="text-2xl font-semibold mb-6">Tambah Buku</h2>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border p-6 max-w-2xl space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="col-span-2">
            ...
            {coverPreview && <img src={coverPreview} className="mt-2 h-32 object-contain rounded border" />}
          </div>
          <div className="col-span-2">
        ...
        <div className="flex gap-3 pt-2">
          <button type="submit" disabled={loading || uploading}
            ...
            {uploading ? 'Mengunggah...' : loading ? 'Menyimpan...' : 'Simpan'}
          </button>
